...
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BootScene.ts`                         | Splash + asset preload, hands off to `GameScene`. Hosts the title screen layout: title (top), tagline, animated stone-arched door (`boot_door` 2-frame spritesheet, frame 0 closed / 1 open), torches flanking the door, "Start" button below the door. Clicking the button plays the procedural `doorOpen` SFX, swaps the door to frame 1, then fades to `GameScene`. | —                                 | `Localization`, `SoundManager`, `MusicManager`                                                     | The **shared** `Localization`, `SoundManager`, `MusicManager` instances passed to all later scenes. Restarts preserve language and audio state.                                          |
