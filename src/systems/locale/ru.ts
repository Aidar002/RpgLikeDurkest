...
export const RU_STRINGS: Record<LocaleKey, string> = {
    ...
    roomTreasureHint: 'тест_roomTreasureHint',
    ...
    roomShrineGenericHint: 'тест_roomShrineGenericHint',
    ...
    roomShadowTraderHint: 'тест_roomShadowTraderHint',
    ...
    roomEmptyHint: 'тест_roomEmptyHint',
    unitGold: 'золота',
