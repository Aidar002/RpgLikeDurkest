...
const TEXT = {
    en: {
        ...
        potionHint: 'A potion heals now. The enemy acts after.',
        ...
        intentAttack: 'Strike',
        intentAttackDetail: 'Incoming damage. Guard reduces it.',
        intentHeavy: 'Heavy strike',
        intentHeavyDetail: 'High damage. Guard or Break is safer.',
        intentGuard: 'Guard',
        intentGuardDetail: 'The enemy will gain block. Break ignores it.',
        intentCharge: 'Prepare',
        intentChargeDetail: 'The next hit will be stronger unless you Break.',
        intentCurse: 'Curse',
        intentCurseDetail: 'Damages you and may drain light. Break stops it.',
    ...
    ru: {
        ...
        intentAttack: 'Удар',
        intentAttackDetail: 'Входящий урон. Блок его снижает.',
        intentHeavy: 'Сильный удар',
        intentHeavyDetail: 'Много урона. Блок или Сломать безопаснее.',
        intentGuard: 'Защита',
        intentGuardDetail: 'Враг получит блок. Сломать его игнорирует.',
        intentCharge: 'Подготовка',
        intentChargeDetail: 'Следующий удар будет сильнее, если его не сорвать.',
        intentCurse: 'Проклятие',
        intentCurseDetail: 'Наносит урон и может гасить свет. Сломать прерывает.',
